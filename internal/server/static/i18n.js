...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "subs.scopeNote": "Once declared, this account can read that account's incoming and outgoing mail anytime (read-only) — for managing the mailboxes you registered for your AI assistants.",
    ...
    zh: {
      ...
      "subs.scopeNote": "声明后，本账户可随时查看该账户收发的邮件（只读）——用于管理你为 AI 助手注册的邮箱。",
