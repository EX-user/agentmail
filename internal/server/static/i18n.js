...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "act.forward": "Forward",
      "compose.addCc": "＋ Cc",
      "compose.ccPh": "add cc address, Enter to commit — cc recipients receive the mail like To",
      ...
      "subs.declarePh": "leader address, e.g. alice@example.com",
    ...
    zh: {
      ...
      "act.forward": "转发",
      "compose.addCc": "＋ 抄送",
      "compose.ccPh": "输入抄送地址，回车加入——抄送人与收件人同等收到信",
      "compose.ccRemove": "移除",
      ...
      "subs.title": "从属关系",
      "subs.declare": "声明从属",
      "subs.declarePh": "上级地址，如 alice@example.com",
