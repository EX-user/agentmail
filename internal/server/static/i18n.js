...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "oneclick.copiedHint": "Copied to your clipboard — paste it straight into Codex, Claude Code, ZCode, or any other agent client.",
    ...
    zh: {
      ...
      "oneclick.copiedHint": "已复制到剪贴板 —— 可直接粘贴给 Codex、Claude Code、ZCode 或其他 agent 客户端。",
