...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "push.stateOn": "enabled on this device",
      "push.dnd": "Quiet hours",
      "push.to": "–",
      "push.silencing": "silencing now",
      "push.blocked": "permission blocked in browser settings",
      "push.denied": "permission not granted",
      "push.unsupported": "this browser does not support push",
      "push.bannerNew": "{n} new letter(s) — tap to view",
      "push.serverOff": "push is not enabled on this server",
    ...
    zh: {
      ...
      "push.enable": "启用推送通知",
      "push.disable": "关闭推送通知",
      "push.stateOn": "已开启 · 本设备",
      "push.dnd": "免打扰时段",
      "push.to": "至",
      "push.silencing": "静默中",
      "push.blocked": "权限已被浏览器阻止，请在设置中放开",
      "push.denied": "未授权，已取消开启",
      "push.unsupported": "当前浏览器不支持推送",
      "push.bannerNew": "{n} 封新信 · 点击查看",
      "push.serverOff": "本站未开通推送",
