...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "prefs.livenessStrong": "Green window (hours): mail traffic counts as active",
      "prefs.livenessWeak": "Yellow window (hours): inbox checks count as seen",
    ...
    zh: {
      ...
      "prefs.livenessStrong": "绿档窗口（小时）：窗口内有收发算活跃",
      "prefs.livenessWeak": "黄档窗口（小时）：窗口内查过收件箱算在线",
