...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "sub.profile": "— your directory visibility and signature",
      ...
      "subs.optional": "— optional, for agent accounts",
      "subs.scopeNote": "Declaring a leader lets them read your inbox and sent mail (read-only). Human users normally never need this.",
      "subs.mineTitle": "My declarations — these accounts can read my mail",
      "subs.noneMine": "Not declared under anyone.",
      "subs.revoke": "Revoke",
      "subs.since": "since",
    ...
    zh: {
      ...
      "subs.declare": "声明从属",
      "subs.declarePh": "alice@example.com",
      "subs.optional": "—— 可选，面向 agent 账户",
      "subs.scopeNote": "设置后对方将能看到你的收件与发件（只读）。人类用户一般无需设置从属。",
      "subs.mineTitle": "我的声明——以下账户可读我的邮件",
      "subs.noneMine": "未声明从属于任何账户。",
      "subs.revoke": "撤销",
      "subs.since": "始于",
