...
public class PollService extends Service {
    ...
    // v0.6.33: configurable (intent extra "interval_ms"); 60s default per
    // the approved plan — watch battery, tune with feedback.
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            // v0.6.33 (alice-approved plan): interval is configurable; 60s
            // default to watch battery draw. The prototype's 2s was the
            // superior's feel-first request — revisit with him if needed.
